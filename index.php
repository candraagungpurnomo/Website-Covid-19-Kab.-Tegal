...
<div class="below">
                ...
                Selamat Datang di Website Pemerintah Kabupaten Tegal<hr style="width:50%;text-align:left;margin-left:338px;color: rgb(74, 77, 255);height: 3px;">
                </h2>
            <div class="sejarah">
                <div class="historikata">
                <img src="assets/images/slawi.png" width=600px height=400px alt="Slawi" style="margin-left: 50px; border-radius: 8px;">
                    <p>Kabupaten Tegal, adalah salah satu kabupaten di Provinsi Jawa Tengah. Ibukotanya adalah Slawi, sekitar 14 km sebelah selatan Kota Tegal. Kabupaten ini berbatasan dengan Kota Tegal dan Laut Jawa di utara, Kabupaten Pemalang di timur, Kabupaten Banyumas di selatan, serta Kabupaten Brebes di selatan dan barat.</p>
                    <p>Bagian utara wilayah Kabupaten Tegal merupakan dataran rendah. Di sebelah selatan merupakan pegunungan, dengan puncaknya Gunung Slamet (3.428 meter), gunung tertinggi di Jawa Tengah. Di perbatasan dengan Kabupaten Pemalang, terdapat rangkaian perbukitan yang tidak terlalu terjal. Di antara sungai besar yang mengalir adalah Kali Gung dan Kali Erang, keduanya bermata air di hulu Gunung Slamet.</p>
                    <p>Kabupaten Tegal terdiri atas 18 kecamatan, yang dibagi lagi atas sejumlah desa dan kelurahan. Pusat pemerintahan berada di Kecamatan Slawi. Slawi dulunya merupakan kota kecamatan, yang kemudian dikembangkan menjadi ibukota kabupaten yang sebelumnya berada di Kota Tegal.</p>
...
<div class="atas">
          <br><br><br><br><h4>Pemerintah Kabupaten Tegal</h4><hr style="width:50%;text-align:left;margin-left:338px;color: rgb(74, 77, 255);height: 3px;">
          <p>Website Pemerintah Kabupaten Tegal ini hadir dengan tampilan dan fitur yang baru serta tata letak <br>yang disesuaikan. Hal ini diharapkan dapat meningkatkan ketersediaan informasi yang dibutuhkan serta dengan <br>memberikan kenyamanan masyarakat saat melakukan akses. Silakan jelajahi website ini dengan mengikuti<br> petunjuk menu-menu yang tersedia. Semoga bermanfaat.</p>
        ...
        <div class="bawah">
          <br><h4><b>BUPATI DAN WAKIL BUPATI<BR>WILAYAH KABUPATEN TEGAL PERIODE 2019-2024</b></h4><hr style="width:60%;text-align:left;margin-left:268px;color: rgb(74, 77, 255);height: 3px;">
            <img src="assets/images/bupati1.png" width=800px height=500px alt="Logo Jakut">
        </div>
