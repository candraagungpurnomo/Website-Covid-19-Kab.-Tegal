...
<nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item"><a class="nav-link link text-secondary display-4" href="../admin/profile.php"><span class="" style="color: rgb(255, 51, 102);"></span>PROFILE</a></li>      

                
            <li class="nav-item dropdown open"><a class="nav-link link text-secondary dropdown-toggle display-4" href="contacts.html" data-toggle="dropdown-submenu" aria-expanded="true"><span class="" style="color: rgb(55, 120, 11);"></span>STATISTIK</a>   <div class="dropdown-menu"><a class="text-secondary dropdown-item display-4" href="tampil_data.php">Sebaran Jumlah</a><div class="dropdown open"></div><a class="text-secondary dropdown-item display-4" href="../leafletpuskesmas/tabeldata.php" aria-expanded="false">Sebaran Objek</a></div></li>   
            <li class="nav-item dropdown open"><a class="nav-link link text-secondary dropdown-toggle display-4" href="contacts.html" data-toggle="dropdown-submenu" aria-expanded="true"><span class="" style="color: rgb(55, 120, 11);"></span>PETA</a>   <div class="dropdown-menu"><a class="text-secondary dropdown-item display-4" href="index.php">Peta Jumlah Sembuh Covid-19</a><div class="dropdown open"></div><a class="text-secondary dropdown-item display-4" href="../leafletpuskesmas/index.php" aria-expanded="false">Peta Persebaran Objek Puskesmas</a></div></li>   
                        
            <li class="nav-item"><a class="nav-link link text-secondary display-4" href="../admin/contacts.php"><span class="" style="color: rgb(255, 51, 102);"></span>CONTACT US</a></li>
...
yang dimiliki oleh Pemerintah Kabupaten Tegal.</p><div class="mbr-section-btn" buttons="0"><></a> <></a></div></div></div></div></div></div><div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(../assets/images/jalanraya.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="../assets/images/ebea5cae-7efd-4c69-9b29-e9fe982d8f72-632x801.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><h2 class="mbr-fonts-style display-1"></h2><p class="lead mbr-text mbr-fonts-style display-5"></p><div class="mbr-section-btn" buttons="0"></div></div></div></div></div></div></div><a data-app-prevent-settings="" class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#slider1-1"><span aria-hidden="true" class="mbri-left mbr-iconfont"></span><span class="sr-only">Previous</span></a><a data-app-prevent-settings="" class="carousel-control carousel-control-next" role="button" data-slide="next" href="#slider1-1"><span aria-hidden="true" class="mbri-right mbr-iconfont"></span><span class="sr-only">Next</span></a></div></div>
    ...
    <div class="bawah">
            ...
            Tampil Data Jumlah Sembuh Covid-19 Kabupaten Tegal<hr style="width:50%;text-align:left;margin-left:338px;color: rgb(74, 77, 255);height: 3px;">
            </h2>
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
    <a href="index.php" class="button button2"> TAMPIL PETA </a> <br><br>



<table border="1" style="margin: 30px auto;">
<tr><th align="center" style= "background-color: orange;">ID KECAMATAN</th>
<td width="155" align="center" style= "background-color: orange;">KECAMATAN</td>
<td width="155" align="center" style= "background-color: orange;">KODEPROP</td>
<td width="155" align="center" style= "background-color: orange;">KODEKAB</td>
<td width="155" align="center" style= "background-color: orange;">JUMLAH SEMBUH COVID-19</td>
<td width="45" align="center" style= "background-color: orange;">AKSI</td>
</tr>

<?php
include"koneksi.php";
$data = mysqli_query($conn,"select * from covidsembuh");
while($d = mysqli_fetch_array($data)){?>
<tr>
<td><?php echo $d['idkec'];?></td>
<td><?php echo $d['kecamatan'];?></td>
<td><?php echo $d['kodeprop'];?></td>
<td><?php echo $d['kodekab'];?></td>
<td><?php echo $d['jml'];?></td>
<td><a href="edit_data.php?idkec=<?php echo $d['idkec']; ?>">EDIT</a> 
<a href="javascript:del(<?php echo $d['idkec'];?>)"></a></td>
</tr>
<?php
};
?>
