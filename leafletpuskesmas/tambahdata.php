...
<div class="two">
<div class="formulir">
<div><br><br><br>Id</div><div><input class="search" type='number' name='id' placeholder="Masukkan nomor.."></div><br>
...
<div>Longitude</div><div><input class="search" type='text' name='lng' placeholder="Masukan Longitude.."></div><br><br>
